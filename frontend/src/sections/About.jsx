    ...
    <section id="about" className="section relative overflow-hidden py-20" ref={ref}>
      ...
      <div className="container-custom relative z-10 lg:pl-32">
        ...
        >
          ...
          <p className="mt-4">
            <a
              href="https://muhalla-tuition-center.netlify.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-indigo-700 font-semibold underline underline-offset-4 hover:text-emerald-600 transition-colors"
            >
